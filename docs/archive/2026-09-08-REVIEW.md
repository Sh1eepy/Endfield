> 历史快照：描述当时的代码与观察，不代表当前实现。最新状态见 [项目状态](../PROJECT_STATE.md)，后续改进见 [变更记录](../CHANGELOG.md)。原始数据与日志仍在 `output/audit_20260908/` 或 `output/audit_20260909/`，部分为本机产物。
...
证据与复现脚本：[output/audit_20260908/inventory.json](<../../output/audit_20260908/inventory.json>)、[output/audit_20260908/probe.py](<../../output/audit_20260908/probe.py>)。
...
代码：[scripts/rag_ask.py](<../../scripts/rag_ask.py>)。复现：[output/audit_20260908/correctness_probe.json](<../../output/audit_20260908/correctness_probe.json>)。
...
代码：[scripts/build_rag.py](<../../scripts/build_rag.py>)、[scripts/build_rag.py](<../../scripts/build_rag.py>)、[scripts/build_rag.py](<../../scripts/build_rag.py>)、[scripts/rag_search.py](<../../scripts/rag_search.py>)。
...
代码：[scripts/llm_client.py](<../../scripts/llm_client.py>)、[scripts/rag_ask.py](<../../scripts/rag_ask.py>)。
...
代码：[miniprogram/utils/api.js](<../../miniprogram/utils/api.js>)、[scripts/llm_client.py](<../../scripts/llm_client.py>)、[scripts/rag_ask.py](<../../scripts/rag_ask.py>)、[scripts/api_server.py](<../../scripts/api_server.py>)、[scripts/api_security.py](<../../scripts/api_security.py>)。
...
代码：[scripts/api_server.py](<../../scripts/api_server.py>)。验证：[output/audit_20260908/correctness_probe.json](<../../output/audit_20260908/correctness_probe.json>)。
...
代码：[scripts/quality_gate.py](<../../scripts/quality_gate.py>)、[scripts/build_eval_manifest.py](<../../scripts/build_eval_manifest.py>)、[.github/workflows/rag-quality.yml](<../../.github/workflows/rag-quality.yml>)。
...
相关代码：[scripts/api_security.py](<../../scripts/api_security.py>)、[scripts/api_server.py](<../../scripts/api_server.py>)、[scripts/api_server.py](<../../scripts/api_server.py>)、[scripts/api_server.py](<../../scripts/api_server.py>)、[scripts/api_server.py](<../../scripts/api_server.py>)、[Dockerfile](<../../Dockerfile>)、[scripts/rag_trace.py](<../../scripts/rag_trace.py>)。
...
代码：[scripts/rag_search.py](<../../scripts/rag_search.py>)、[scripts/rag_search.py](<../../scripts/rag_search.py>)、[scripts/rag_ask.py](<../../scripts/rag_ask.py>)、[scripts/rag_ask.py](<../../scripts/rag_ask.py>)、[scripts/rag_ask.py](<../../scripts/rag_ask.py>)。
...
代码：[scripts/rag_ask.py](<../../scripts/rag_ask.py>)、[scripts/rag_ask.py](<../../scripts/rag_ask.py>)、[scripts/graph_search.py](<../../scripts/graph_search.py>)、[scripts/graph_search.py](<../../scripts/graph_search.py>)、[scripts/build_knowledge_graph.py](<../../scripts/build_knowledge_graph.py>)。
...
代码：[scripts/eval_answers.py](<../../scripts/eval_answers.py>)、[scripts/eval_case.py](<../../scripts/eval_case.py>)、[scripts/build_eval_manifest.py](<../../scripts/build_eval_manifest.py>)。
历史成绩快照：[output/audit_20260908/existing_evaluations.json](<../../output/audit_20260908/existing_evaluations.json>)。
...
代码：[web/src/App.tsx](<../../web/src/App.tsx>)、[web/src/components/Hero.tsx](<../../web/src/components/Hero.tsx>)、[web/src/components/EntryCurtain.tsx](<../../web/src/components/EntryCurtain.tsx>)、[web/src/components/SearchBox.tsx](<../../web/src/components/SearchBox.tsx>)、[web/src/components/SynTree.tsx](<../../web/src/components/SynTree.tsx>)。
...
代码：[miniprogram/utils/api.js](<../../miniprogram/utils/api.js>)、[miniprogram/pages/index/index.js](<../../miniprogram/pages/index/index.js>)、[miniprogram/pages/ask/ask.js](<../../miniprogram/pages/ask/ask.js>)、[miniprogram/pages/ask/ask.js](<../../miniprogram/pages/ask/ask.js>)、[miniprogram/pages/ask/ask.js](<../../miniprogram/pages/ask/ask.js>)、[miniprogram/components/synth-tree/synth-tree.js](<../../miniprogram/components/synth-tree/synth-tree.js>)。
