...
项目数据来自《明日方舟：终末地》官方 WIKI 的公开条目，界面素材来自游戏官网等公开渠道，均经过来源登记。本项目是**非官方社区工具**，与权利方无隶属或合作关系，不收费、不含广告，仅供查询与学习交流。完整的素材清单、字体许可、数据来源、使用边界与免责声明见 [素材、数据与免责声明](docs/ASSETS.md)。
